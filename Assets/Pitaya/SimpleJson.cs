...
namespace Pitaya.SimpleJson
{
			...
			class SimpleJson
	{
		...
		public static object DeserializeObject(string json, Type type, IJsonSerializerStrategy jsonSerializerStrategy, object defaultValue = null)
		{
			...
			return type == null || jsonObject != null &&
				...
				jsonObject.GetType().GetTypeInfo().IsAssignableFrom(type.GetTypeInfo())
					...
					#endif
					? jsonObject
					: (jsonSerializerStrategy ?? CurrentJsonSerializerStrategy).DeserializeObject(jsonObject, type, defaultValue);
		}
		
		public static object DeserializeObject(string json, Type type)
		{
			return DeserializeObject(json, type, null, null);
		}

		public static T DeserializeObject<T>(string json, T defaultValue)
		{
			return (T)DeserializeObject(json, typeof(T), null, defaultValue);
		}
		...
		{
			return (T)DeserializeObject(json, typeof(T), null, null);
		}
			...
			interface IJsonSerializerStrategy
	{
		...
		object DeserializeObject(object value, Type type, object defaultValue = null);
	}
			...
			class PocoJsonSerializerStrategy : IJsonSerializerStrategy
	{
		...
		protected virtual void BuildMap(Type type, SafeDictionary<string, CacheResolver.MemberMap> memberMaps)
		{
			...
			foreach (PropertyInfo info in type.GetTypeInfo().DeclaredProperties) {
				...
				[SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
				public virtual object DeserializeObject(object value, Type type, object defaultInstance = null)
				{
					object obj = null;
					if (value is string)
					{
